...
sealed class BasicDashboardDemo : PureComponent
{
    ...
    {
        return new FlexRow(WebkitBoxOrient("horizontal"), WebkitBoxDirection("normal"), WebkitBoxPack("justify"), JustifyContentSpaceBetween, WebkitBoxAlign("center"), AlignItemsCenter, WebkitBoxFlex("1"), FlexGrow(1), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)), PaddingLeftRight(24))
        {
            ...
            {
                new button("sidebarToggle ? 'lg:bg-transparent dark:lg:bg-transparent bg-gray-100 dark:bg-gray-800' : ''", BorderWidth(1), Width("2.75rem"), Height(44), Color(rgb(102, 112, 133)), BorderColor(rgb(228, 231, 236)), BorderRadius(8), WebkitBoxPack("center"), JustifyContentCenter, WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, ZIndex("99999"), CursorPointer, Appearance("button"), BackgroundColor("rgba(0, 0, 0, 0)"), BackgroundImage(none), TextTransform(none), FontFamily("Outfit, sans-serif"), FontFeatureSettings("normal"), FontVariationSettings("normal"), FontSize16, FontWeight400, LineHeight24, LetterSpacingNormal, Margin(0), Padding(0), BoxSizingBorderBox, BorderStyle(solid))
                {
                    new svg(svg.Width(16), svg.Height(12), ViewBox(0, 0, 16, 12), Fill(none), DisplayBlock, Fill(rgb(102, 112, 133)), VerticalAlignMiddle, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)), TouchAction(none))
                    {
                    ...
                    new svg("sidebarToggle ? 'hidden' : 'block lg:hidden'", ViewBox(0, 0, 24, 24), Fill(none), svg.Size(24), DisplayNone, Fill(rgb(102, 112, 133)), VerticalAlignMiddle, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)), TouchAction(none))
                    {
                        new path(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                        {
                            fillRule = "evenodd",
                    ...
                    new svg("sidebarToggle ? 'block lg:hidden' : 'hidden'", ViewBox(0, 0, 24, 24), Fill(none), svg.Size(24), Fill(rgb(102, 112, 133)), DisplayNone, VerticalAlignMiddle, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)), TouchAction(none))
                    {
                        new path(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                        {
                            fillRule = "evenodd",
    ...
    {
        return new aside("sidebarToggle ? 'translate-x-0 lg:w-[90px]' : '-translate-x-full'", Transform("matrix(1, 0, 0, 1, 0, 0)"), PositionStatic, Width(290), BackgroundColor(rgb(255, 255, 255)), BorderColor(rgb(228, 231, 236)), BorderRightWidth("1px"), OverflowY("hidden"), WebkitBoxOrient("vertical"), WebkitBoxDirection("normal"), FlexDirectionColumn, Height(675), DisplayFlex, ZIndex("9999"), Top(0), Left(0), BoxSizingBorderBox, BorderWidth("0px 1px 0px 0px"), BorderStyle(solid), PaddingLeftRight(20))
        {
            new FlexRow("sidebarToggle ? 'justify-center' : 'justify-between'", WebkitBoxPack("justify"), JustifyContentSpaceBetween, PaddingTop(32), PaddingBottom(28), Gap(8), WebkitBoxAlign("center"), AlignItemsCenter, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
            {
                new a(Href("index.html"), Color(rgb(0, 0, 0)), TextDecoration("none solid rgb(0, 0, 0)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                {
                    new span("sidebarToggle ? 'hidden' : ''", DisplayBlock, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                    {
                        new img(Src("src/images/logo/logo.svg"), Alt("Logo"), MaxWidth("100%"), HeightAuto, DisplayBlock, VerticalAlignMiddle, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236))),
                        new img(Src("src/images/logo/logo-dark.svg"), Alt("Logo"), DisplayNone, MaxWidth("100%"), HeightAuto, VerticalAlignMiddle, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                    },
                    new img("sidebarToggle ? 'lg:block' : 'hidden'", Src("src/images/logo/logo-icon.svg"), Alt("Logo"), DisplayNone, MaxWidth("100%"), HeightAuto, VerticalAlignMiddle, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                }
            },
            new FlexColumn(ScrollbarWidth(none), TransitionTimingFunction("linear"), TransitionDuration("0.3s"), OverflowYAuto, WebkitBoxOrient("vertical"), WebkitBoxDirection("normal"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
            {
                new nav(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                {
                    new div(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                    {
                        new h3(Color(rgb(152, 162, 179)), LineHeight20, TextTransformUpperCase, FontSize12, MarginBottom(16), Margin(0, 0, 16), FontWeight400, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                        {
                            new span("sidebarToggle ? 'lg:hidden' : ''", DisplayBlock, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                            {
                                "MENU"
                            },
                            new svg("sidebarToggle ? 'lg:block hidden' : 'hidden'", ViewBox(0, 0, 24, 24), Fill(none), svg.Size(24), DisplayNone, Fill(rgb(152, 162, 179)), MarginLeft(auto), MarginRight(auto), VerticalAlignMiddle, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)), TouchAction(none))
                            {
                                new path(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                {
                                    fillRule = "evenodd",
                        ...
                        new ul(Gap(16), WebkitBoxOrient("vertical"), WebkitBoxDirection("normal"), FlexDirectionColumn, DisplayFlex, MarginBottom(24), ListStyle("outside none none"), Margin(0, 0, 24), Padding(0), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                        {
                            new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                            {
                                new a(" (selected === 'Dashboard') || (page === 'ecommerce' || page === 'analytics' || page === 'marketing' || page === 'crm' || page === 'stocks') ? 'menu-item-active' : 'menu-item-inactive'", Href("#"), BackgroundColor(rgb(236, 243, 255)), Color(rgb(70, 95, 255)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(8, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(70, 95, 255)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                {
                                    new svg("(selected === 'Dashboard') || (page === 'ecommerce' || page === 'analytics' || page === 'marketing' || page === 'crm' || page === 'stocks') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'", ViewBox(0, 0, 24, 24), Fill(none), svg.Size(24), Fill(rgb(70, 95, 255)), DisplayBlock, VerticalAlignMiddle, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)), TouchAction(none))
                                    {
                                        new path(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            fillRule = "evenodd",
                                    ...
                                    new svg("[(selected === 'Dashboard') ? 'menu-item-arrow-active' : 'menu-item-arrow-inactive', sidebarToggle ? 'lg:hidden' : '' ]", ViewBox(0, 0, 20, 20), Fill(none), svg.Size(20), DisplayBlock, Transform("matrix(-1, 0, 0, -1, 0, -10)"), Stroke(rgb(70, 95, 255)), PositionAbsolute, Right(10), Top(20), VerticalAlignMiddle, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)), TouchAction(none))
                                    {
                                        new path(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                ...
                                new div("(selected === 'Dashboard') ? 'block' :'hidden'", OverflowHidden, Transform("matrix(1, 0, 0, 1, 0, 0)"), DisplayBlock, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                {
                                    new ul("sidebarToggle ? 'lg:hidden' : 'flex'", DisplayFlex, PaddingLeft(36), Gap(4), WebkitBoxOrient("vertical"), WebkitBoxDirection("normal"), FlexDirectionColumn, MarginTop(8), ListStyle("outside none none"), Margin(8, 0, 0), Padding(0, 0, 0, 36), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                    {
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'ecommerce' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("index.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                "eCommerce"
                                            }
                                        },
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'analytics' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("analytics.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        Analytics
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'analytics' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                                        ...
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'marketing' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("marketing.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        Marketing
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'marketing' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                                        ...
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'crm' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("crm.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        CRM
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'crm' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                                        ...
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'stocks' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("stocks.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        Stocks
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'stocks' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "New"
                                                    },
                                                    new span("page === 'stocks' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                            ...
                            new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                            {
                                new a(" (selected === 'Calendar') &amp;&amp; (page === 'calendar') ? 'menu-item-active' : 'menu-item-inactive'", Href("calendar.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(8, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                {
                                    new svg("(selected === 'Calendar') &amp;&amp; (page === 'calendar') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'", ViewBox(0, 0, 24, 24), Fill(none), svg.Size(24), Fill(rgb(102, 112, 133)), DisplayBlock, VerticalAlignMiddle, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)), TouchAction(none))
                                    {
                                        new path(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            fillRule = "evenodd",
                            ...
                            new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                            {
                                new a(" (selected === 'Profile') &amp;&amp; (page === 'profile') ? 'menu-item-active' : 'menu-item-inactive'", Href("profile.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(8, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                {
                                    new svg("(selected === 'Profile') &amp;&amp; (page === 'profile') ?  'menu-item-icon-active'  :'menu-item-icon-inactive'", ViewBox(0, 0, 24, 24), Fill(none), svg.Size(24), Fill(rgb(102, 112, 133)), DisplayBlock, VerticalAlignMiddle, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)), TouchAction(none))
                                    {
                                        new path(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            fillRule = "evenodd",
                            ...
                            new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                            {
                                new a(" (selected === 'Task') || (page === 'taskList' || page === 'taskKanban') ? 'menu-item-active' : 'menu-item-inactive'", Href("#"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(8, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                {
                                    new svg("(selected === 'Task') || (page === 'taskList' || page === 'taskKanban') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'", ViewBox(0, 0, 24, 24), Fill(none), svg.Size(24), Fill(rgb(102, 112, 133)), DisplayBlock, VerticalAlignMiddle, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)), TouchAction(none))
                                    {
                                        new path(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            fillRule = "evenodd",
                                    ...
                                    new svg("[(selected === 'Task') ? 'menu-item-arrow-active' : 'menu-item-arrow-inactive', sidebarToggle ? 'lg:hidden' : '' ]", ViewBox(0, 0, 20, 20), Fill(none), svg.Size(20), DisplayBlock, Stroke(rgb(102, 112, 133)), PositionAbsolute, Right(10), Top(20), Transform("matrix(1, 0, 0, 1, 0, -10)"), VerticalAlignMiddle, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)), TouchAction(none))
                                    {
                                        new path(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            d              = "M4.79175 7.39584L10.0001 12.6042L15.2084 7.39585",
                                ...
                                new div("(selected === 'Task') ? 'block' :'hidden'", OverflowHidden, Transform(none), DisplayNone, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                {
                                    new ul("sidebarToggle ? 'lg:hidden' : 'flex'", DisplayFlex, PaddingLeft(36), Gap(4), WebkitBoxOrient("vertical"), WebkitBoxDirection("normal"), FlexDirectionColumn, MarginTop(8), ListStyle("outside none none"), Margin(8, 0, 0), Padding(0, 0, 0, 36), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                    {
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'taskList' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("task-list.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        List
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'taskList' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                                        ...
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'taskKanban' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("task-kanban.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        Kanban
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'taskKanban' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                            ...
                            new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                            {
                                new a(" (selected === 'Forms') || (page === 'formElements' || page === 'formLayout' || page === 'proFormElements' || page === 'proFormLayout') ? 'menu-item-active' : 'menu-item-inactive'", Href("#"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(8, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                {
                                    new svg("(selected === 'Forms') || (page === 'formElements' || page === 'formLayout' || page === 'proFormElements' || page === 'proFormLayout') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'", ViewBox(0, 0, 24, 24), Fill(none), svg.Size(24), Fill(rgb(102, 112, 133)), DisplayBlock, VerticalAlignMiddle, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)), TouchAction(none))
                                    {
                                        new path(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            fillRule = "evenodd",
                                    ...
                                    new svg("[(selected === 'Forms') ? 'menu-item-arrow-active' : 'menu-item-arrow-inactive', sidebarToggle ? 'lg:hidden' : '' ]", ViewBox(0, 0, 20, 20), Fill(none), svg.Size(20), DisplayBlock, Stroke(rgb(52, 64, 84)), Transform("matrix(1, 0, 0, 1, 0, -10)"), Top(20), Right(10), PositionAbsolute, VerticalAlignMiddle, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)), TouchAction(none))
                                    {
                                        new path(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            d              = "M4.79175 7.39584L10.0001 12.6042L15.2084 7.39585",
                                ...
                                new div("(selected === 'Forms') ? 'block' :'hidden'", OverflowHidden, Transform(none), DisplayNone, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                {
                                    new ul("sidebarToggle ? 'lg:hidden' : 'flex'", DisplayFlex, PaddingLeft(36), Gap(4), WebkitBoxOrient("vertical"), WebkitBoxDirection("normal"), FlexDirectionColumn, MarginTop(8), ListStyle("outside none none"), Margin(8, 0, 0), Padding(0, 0, 0, 36), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                    {
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'formElements' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("form-elements.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                "Form Elements"
                                            }
                                        },
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'formLayout' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("form-layout.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                "Form Layout"
                                            }
                                        }
                            ...
                            new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                            {
                                new a("(selected === 'Tables') || (page === 'basicTables' || page === 'dataTables') ? 'menu-item-active' : 'menu-item-inactive'", Href("#"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(8, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                {
                                    new svg("(selected === 'Tables') || (page === 'basicTables' || page === 'dataTables') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'", ViewBox(0, 0, 24, 24), Fill(none), svg.Size(24), Fill(rgb(102, 112, 133)), DisplayBlock, VerticalAlignMiddle, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)), TouchAction(none))
                                    {
                                        new path(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            fillRule = "evenodd",
                                    ...
                                    new svg("[(selected === 'Tables') ? 'menu-item-arrow-active' : 'menu-item-arrow-inactive', sidebarToggle ? 'lg:hidden' : '' ]", ViewBox(0, 0, 20, 20), Fill(none), svg.Size(20), DisplayBlock, Stroke(rgb(52, 64, 84)), Transform("matrix(1, 0, 0, 1, 0, -10)"), Top(20), Right(10), PositionAbsolute, VerticalAlignMiddle, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)), TouchAction(none))
                                    {
                                        new path(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            d              = "M4.79175 7.39584L10.0001 12.6042L15.2084 7.39585",
                                ...
                                new div("(selected === 'Tables') ? 'block' :'hidden'", OverflowHidden, Transform(none), DisplayNone, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                {
                                    new ul("sidebarToggle ? 'lg:hidden' : 'flex'", DisplayFlex, PaddingLeft(36), Gap(4), WebkitBoxOrient("vertical"), WebkitBoxDirection("normal"), FlexDirectionColumn, MarginTop(8), ListStyle("outside none none"), Margin(8, 0, 0), Padding(0, 0, 0, 36), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                    {
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'basicTables' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("basic-tables.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                "Basic Tables"
                                            }
                                        },
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'dataTables' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("data-tables.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        Data Tables
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'dataTables' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                            ...
                            new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                            {
                                new a("(selected === 'Pages') || (page === 'fileManager' || page === 'pricingTables' || page === 'blank' || page === 'page404' || page === 'page500' || page === 'page503' || page === 'success' || page === 'faq' || page === 'comingSoon' || page === 'maintenance') ? 'menu-item-active' : 'menu-item-inactive'", Href("#"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(8, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                {
                                    ...
                                    new svg("[(selected === 'Pages') ? 'menu-item-arrow-active' : 'menu-item-arrow-inactive', sidebarToggle ? 'lg:hidden' : '' ]", ViewBox(0, 0, 20, 20), Fill(none), svg.Size(20), DisplayBlock, Stroke(rgb(52, 64, 84)), Transform("matrix(1, 0, 0, 1, 0, -10)"), Top(20), Right(10), PositionAbsolute, VerticalAlignMiddle, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)), TouchAction(none))
                                    {
                                        new path(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            d              = "M4.79175 7.39584L10.0001 12.6042L15.2084 7.39585",
                                ...
                                new div("(selected === 'Pages') ? 'block' :'hidden'", OverflowHidden, Transform(none), DisplayNone, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                {
                                    new ul("sidebarToggle ? 'lg:hidden' : 'flex'", DisplayFlex, PaddingLeft(36), Gap(4), WebkitBoxOrient("vertical"), WebkitBoxDirection("normal"), FlexDirectionColumn, MarginTop(8), ListStyle("outside none none"), Margin(8, 0, 0), Padding(0, 0, 0, 36), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                    {
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'fileManager' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("file-manager.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        File Manager
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'fileManager' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                                        ...
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'pricingTables' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("pricing-tables.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        Pricing Tables
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'pricingTables' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                                        ...
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'faq' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("faq.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        Faq
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'faq' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                                        ...
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'blank' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("blank.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        Blank Page
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'blank' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                                        ...
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'page404' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("404.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        404 Error
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'page404' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                                        ...
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'page500' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("500.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        500 Error
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'page500' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                                        ...
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'page503' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("503.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        503 Error
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'page503' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                                        ...
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'comingSoon' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("coming-soon.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        Coming Soon
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'comingSoon' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                                        ...
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'termsCondition' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("maintenance.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        Maintenance
                                        ",
                                        ...
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'success' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("success.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        Success
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'success' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                    ...
                    new div(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                    {
                        ...
                        new ul(Gap(16), WebkitBoxOrient("vertical"), WebkitBoxDirection("normal"), FlexDirectionColumn, DisplayFlex, MarginBottom(24), ListStyle("outside none none"), Margin(0, 0, 24), Padding(0), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                        {
                            new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                            {
                                new a(" (selected === 'Chat') &amp;&amp; (page === 'chat') ? 'menu-item-active' : 'menu-item-inactive'", Href("chat.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(8, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                {
                                    new svg("(selected === 'Chat') &amp;&amp; (page === 'chat') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'", ViewBox(0, 0, 24, 24), Fill(none), svg.Size(24), Fill(rgb(102, 112, 133)), DisplayBlock, VerticalAlignMiddle, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)), TouchAction(none))
                                    {
                                        new path(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            fillRule = "evenodd",
                            ...
                            new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                            {
                                new a("(selected === 'Email') || (page === 'inbox' || page === 'inboxDetails') ? 'menu-item-active' : 'menu-item-inactive'", Href("#"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(8, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                {
                                    new svg("(selected === 'Email') || (page === 'inbox' || page === 'inboxDetails') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'", ViewBox(0, 0, 24, 24), Fill(none), svg.Size(24), Fill(rgb(102, 112, 133)), DisplayBlock, VerticalAlignMiddle, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)), TouchAction(none))
                                    {
                                        new path(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            fillRule = "evenodd",
                                    ...
                                    new svg("[(selected === 'Email') ? 'menu-item-arrow-active' : 'menu-item-arrow-inactive', sidebarToggle ? 'lg:hidden' : '' ]", ViewBox(0, 0, 20, 20), Fill(none), svg.Size(20), DisplayBlock, Stroke(rgb(52, 64, 84)), Transform("matrix(1, 0, 0, 1, 0, -10)"), Top(20), Right(10), PositionAbsolute, VerticalAlignMiddle, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)), TouchAction(none))
                                    {
                                        new path(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            d              = "M4.79175 7.39584L10.0001 12.6042L15.2084 7.39585",
                                ...
                                new div("(selected === 'Email') ? 'block' :'hidden'", OverflowHidden, Transform(none), DisplayNone, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                {
                                    new ul("sidebarToggle ? 'lg:hidden' : 'flex'", DisplayFlex, PaddingLeft(36), Gap(4), WebkitBoxOrient("vertical"), WebkitBoxDirection("normal"), FlexDirectionColumn, MarginTop(8), ListStyle("outside none none"), Margin(8, 0, 0), Padding(0, 0, 0, 36), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                    {
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'inbox' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("inbox.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        Inbox
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'inbox' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                                        ...
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'inboxDetails' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("inbox-details.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        Details
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'inboxDetails' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                            ...
                            new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                            {
                                new a(" (selected === 'Invoice') &amp;&amp; (page === 'invoice') ? 'menu-item-active' : 'menu-item-inactive'", Href("invoice.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(8, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                {
                                    new svg("(selected === 'Invoice') &amp;&amp; (page === 'invoice') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'", ViewBox(0, 0, 24, 24), Fill(none), svg.Size(24), Fill(rgb(102, 112, 133)), DisplayBlock, VerticalAlignMiddle, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)), TouchAction(none))
                                    {
                                        new path(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            fillRule = "evenodd",
                    ...
                    new div(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                    {
                        ...
                        new ul(Gap(16), WebkitBoxOrient("vertical"), WebkitBoxDirection("normal"), FlexDirectionColumn, DisplayFlex, MarginBottom(24), ListStyle("outside none none"), Margin(0, 0, 24), Padding(0), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                        {
                            new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                            {
                                new a("(selected === 'Charts') || (page === 'lineChart' || page === 'barChart' || page === 'pieChart') ? 'menu-item-active' : 'menu-item-inactive'", Href("#"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(8, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                {
                                    new svg("(selected === 'Charts') || (page === 'lineChart' || page === 'barChart' || page === 'pieChart') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'", ViewBox(0, 0, 24, 24), Fill(none), svg.Size(24), Fill(rgb(102, 112, 133)), DisplayBlock, VerticalAlignMiddle, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)), TouchAction(none))
                                    {
                                        new path(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            fillRule = "evenodd",
                                    ...
                                    new svg("[(selected === 'Charts') ? 'menu-item-arrow-active' : 'menu-item-arrow-inactive', sidebarToggle ? 'lg:hidden' : '' ]", ViewBox(0, 0, 20, 20), Fill(none), svg.Size(20), DisplayBlock, Stroke(rgb(52, 64, 84)), Transform("matrix(1, 0, 0, 1, 0, -10)"), Top(20), Right(10), PositionAbsolute, VerticalAlignMiddle, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)), TouchAction(none))
                                    {
                                        new path(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            d              = "M4.79175 7.39584L10.0001 12.6042L15.2084 7.39585",
                                ...
                                new div("(selected === 'Charts') ? 'block' :'hidden'", OverflowHidden, Transform(none), DisplayNone, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                {
                                    new ul("sidebarToggle ? 'lg:hidden' : 'flex'", DisplayFlex, PaddingLeft(36), Gap(4), WebkitBoxOrient("vertical"), WebkitBoxDirection("normal"), FlexDirectionColumn, MarginTop(8), ListStyle("outside none none"), Margin(8, 0, 0), Padding(0, 0, 0, 36), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                    {
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'lineChart' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("line-chart.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        Line Chart
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'lineChart' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                                        ...
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'barChart' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("bar-chart.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        Bar Chart
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'barChart' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                                        ...
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'pieChart' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("pie-chart.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        Pie Chart
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'pieChart' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                            ...
                            new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                            {
                                new a("(selected === 'UiElements') || (page === 'alerts' || page === 'avatars' || page === 'badge' || page === 'breadcrumb' || page === 'buttons' || page === 'buttonsGroup' || page === 'cards'|| page === 'carousel' || page === 'dropdowns' || page === 'images' || page === 'list' || page === 'modals' || page === 'notifications' || page === 'pagination' || page === 'popovers' || page === 'progress' || page === 'spinners' || page === 'tooltips' || page === 'videos') ? 'menu-item-active' : 'menu-item-inactive'", Href("#"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(8, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                {
                                    ...
                                    new svg("[(selected === 'UiElements') ? 'menu-item-arrow-active' : 'menu-item-arrow-inactive', sidebarToggle ? 'lg:hidden' : '' ]", ViewBox(0, 0, 20, 20), Fill(none), svg.Size(20), DisplayBlock, Stroke(rgb(52, 64, 84)), Transform("matrix(1, 0, 0, 1, 0, -10)"), Top(20), Right(10), PositionAbsolute, VerticalAlignMiddle, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)), TouchAction(none))
                                    {
                                        new path(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            d              = "M4.79175 7.39584L10.0001 12.6042L15.2084 7.39585",
                                ...
                                new div("(selected === 'UiElements') ? 'block' :'hidden'", OverflowHidden, Transform(none), DisplayNone, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                {
                                    new ul("sidebarToggle ? 'lg:hidden' : 'flex'", DisplayFlex, PaddingLeft(36), Gap(4), WebkitBoxOrient("vertical"), WebkitBoxDirection("normal"), FlexDirectionColumn, MarginTop(8), ListStyle("outside none none"), Margin(8, 0, 0), Padding(0, 0, 0, 36), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                    {
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'alerts' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("alerts.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        Alerts
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'alerts' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                                        ...
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'avatars' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("avatars.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        Avatars
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'avatars' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                                        ...
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'badge' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("badge.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        Badge
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'badge' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                                        ...
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'breadcrumb' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("breadcrumb.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        Breadcrumb
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'breadcrumb' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                                        ...
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'buttons' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("buttons.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        Buttons
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'buttons' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                                        ...
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'buttonsGroup' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("buttons-group.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        Buttons Group
                                        ",
                                        ...
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'cards' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("cards.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        Cards
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'cards' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                                        ...
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'carousel' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("carousel.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        Carousel
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'carousel' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                                        ...
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'dropdowns' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("dropdowns.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        Dropdowns
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'dropdowns' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                                        ...
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'images' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("images.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        Images
                                        ",
                                        ...
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'links' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("links.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        Links
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'links' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                                        ...
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'list' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("list.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        List
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'list' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                                        ...
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'modals' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("modals.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        Modals
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'modals' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                                        ...
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'notifications' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("notifications.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        Notifications
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'notifications' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                                        ...
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'pagination' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("pagination.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        Pagination
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'pagination' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                                        ...
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'popovers' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("popovers.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        Popovers
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'popovers' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                                        ...
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'progress' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("progress-bar.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        Progress Bars
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'progress' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                                        ...
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'ribbons' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("ribbons.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        Ribbons
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'ribbons' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                                        ...
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'spinners' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("spinners.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        Spinners
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'spinners' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                                        ...
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'tabs' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("tabs.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        Tabs
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'tabs' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                                        ...
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'tooltips' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("tooltips.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        Tooltips
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'tooltips' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                                        ...
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'videos' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("videos.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        Videos
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'videos' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                            ...
                            new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                            {
                                new a("(selected === 'Authentication') || (page === 'basicChart' || page === 'advancedChart') ? 'menu-item-active' : 'menu-item-inactive'", Href("#"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(8, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                {
                                    new svg("(selected === 'Authentication') || (page === 'basicChart' || page === 'advancedChart') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'", ViewBox(0, 0, 24, 24), Fill(none), svg.Size(24), Fill(rgb(102, 112, 133)), DisplayBlock, VerticalAlignMiddle, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)), TouchAction(none))
                                    {
                                        new path(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            fillRule = "evenodd",
                                    ...
                                    new svg("[(selected === 'Authentication') ? 'menu-item-arrow-active' : 'menu-item-arrow-inactive', sidebarToggle ? 'lg:hidden' : '' ]", ViewBox(0, 0, 20, 20), Fill(none), svg.Size(20), DisplayBlock, Stroke(rgb(52, 64, 84)), Transform("matrix(1, 0, 0, 1, 0, -10)"), Top(20), Right(10), PositionAbsolute, VerticalAlignMiddle, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)), TouchAction(none))
                                    {
                                        new path(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            d              = "M4.79175 7.39584L10.0001 12.6042L15.2084 7.39585",
                                ...
                                new div("(selected === 'Authentication') ? 'block' :'hidden'", OverflowHidden, Transform(none), DisplayNone, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                {
                                    new ul("sidebarToggle ? 'lg:hidden' : 'flex'", DisplayFlex, PaddingLeft(36), Gap(4), WebkitBoxOrient("vertical"), WebkitBoxDirection("normal"), FlexDirectionColumn, MarginTop(8), ListStyle("outside none none"), Margin(8, 0, 0), Padding(0, 0, 0, 36), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                    {
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'signin' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("signin.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                "Sign In"
                                            }
                                        },
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'signup' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("signup.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                "Sign Up"
                                            }
                                        },
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'resetPassword' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("reset-password.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        Reset Password
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'resetPassword' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                                        ...
                                        new li(BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                        {
                                            new a("page === 'twoStepVerification' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'", Href("two-step-verification.html"), Color(rgb(52, 64, 84)), PositionRelative, DisplayFlex, WebkitBoxAlign("center"), AlignItemsCenter, Gap(12), BorderRadius(8), Padding(10, 12), FontSize14, LineHeight20, FontWeight500, TextDecoration("none solid rgb(52, 64, 84)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                            {
                                                @"
                                        ...
                                        ",
                                                new span(Gap(4), WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, Right(12), PositionAbsolute, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                {
                                                    new span("page === 'twoStepVerification' ? 'menu-dropdown-badge-active' : 'menu-dropdown-badge-inactive'", BackgroundColor(rgb(236, 243, 255)), DisplayBlock, BorderRadius(9999), Padding(2, 10), FontSize12, LineHeight16, FontWeight500, TextTransformUpperCase, Color(rgb(70, 95, 255)), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                                                    {
                                                        "Pro"
                                                    }
                                                }
                ...
                new div("sidebarToggle ? 'lg:hidden' : ''", TextAlignCenter, BackgroundColor(rgb(249, 250, 251)), BorderRadius(16), MaxWidth(240), WidthFull, MarginBottom(40), MarginLeft(auto), MarginRight(auto), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)), Padding(20, 16))
                {
                    new h3(Color(rgb(16, 24, 40)), FontWeight600, MarginBottom(8), Margin(0, 0, 8), FontSize16, BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                    {
                        "TailAdmin Pro"
                    },
                    new p(Color(rgb(102, 112, 133)), FontSize14, LineHeight20, MarginBottom(16), Margin(0, 0, 16), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                    {
                        "Get All Dashboards and 300+ UI Elements"
                    },
                    new a(Href("https://tailadmin.com/pricing"), TargetBlank, Rel("nofollow"), Color(rgb(255, 255, 255)), FontWeight500, FontSize14, LineHeight20, Padding(12), BackgroundColor(rgb(70, 95, 255)), BorderRadius(8), WebkitBoxPack("center"), JustifyContentCenter, WebkitBoxAlign("center"), AlignItemsCenter, DisplayFlex, TextDecoration("none solid rgb(255, 255, 255)"), BoxSizingBorderBox, BorderWidth(0), BorderStyle(solid), BorderColor(rgb(228, 231, 236)))
                    {
                        "Upgrade Plan"
                    }
                }
