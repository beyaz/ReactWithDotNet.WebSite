                            ...
                            new div(Padding(24), OverflowAuto, WebkitBoxFlex("1"), Flex("1 1 0%"), MaxHeight("100%"), BoxSizingBorderBox)
                            {
                                new div(MaxWidth(350), BoxSizingBorderBox)
                                {
                                    new FlexRow(Gap(16), WebkitBoxAlign("start"), AlignItemsFlexStart, BoxSizingBorderBox)
                                    {
                                        ...
                                        {
                                            new img(Src(DummySrc(48)), Alt("profile"), ObjectPosition("50% 50%"), ObjectFitCover, BorderRadius(9999), OverflowHidden, WidthFull, Height(40), MaxWidth("100%"), DisplayBlock, VerticalAlignMiddle, BoxSizingBorderBox)
                                        },
                                        new div(BoxSizingBorderBox)
                                        {
                                ...
                                new div(MarginTop(32), MarginBottom(0), MaxWidth(350), BoxSizingBorderBox)
                                {
                                    new FlexRow(Gap(16), WebkitBoxAlign("start"), AlignItemsFlexStart, BoxSizingBorderBox)
                                    {
                                        new div(BorderRadius(9999), MaxWidth(40), WidthFull, Height(40), BoxSizingBorderBox)
                                        {
                                            new img(Src(DummySrc(40)), Alt("profile"), ObjectPosition("50% 50%"), ObjectFitCover, BorderRadius(9999), OverflowHidden, WidthFull, Height(40), MaxWidth("100%"), DisplayBlock, VerticalAlignMiddle, BoxSizingBorderBox)
                                        },
                                        new div(BoxSizingBorderBox)
                                        {
                                            new div(BorderRadius(8), OverflowHidden, MaxWidth(270), WidthFull, MarginBottom(8), BoxSizingBorderBox)
                                            {
                                                new img(Src(DummySrc(250)), Alt("chat"), MaxWidth("100%"), HeightAuto, DisplayBlock, VerticalAlignMiddle, BoxSizingBorderBox)
                                            },
